...
import { createFeeTypeAction, updateFeeTypeAction, deleteFeeTypeAction, getFeeTypesPageDataAction, assignFeeTypeToStudentsAction, updateStudentFeeAction, deleteStudentFeeAssignmentAction } from './actions';
...
export default function ManageFeeTypesPage() {
  ...
  const handleDeleteFeeType = async (feeTypeId: string) => {
    ...
    setIsSubmitting(true);
    const result = await deleteFeeTypeAction(feeTypeId, currentSchoolId);
  ...
  const handleAssignSubmit = async (e: FormEvent) => {
    ...
    setIsSubmitting(true);
    const result = await assignFeeTypeToStudentsAction({
    ...
    <div className="flex flex-col gap-6">
      ...
      <Tabs defaultValue="plans">
        ...
        <TabsContent value="assign">
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center"><Receipt className="mr-2 h-5 w-5"/>Assign Fee by Type</CardTitle>
                    <CardDescription>Assign a fee type to a whole class or individual students.</CardDescription>
                </CardHeader>
